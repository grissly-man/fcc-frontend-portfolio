...
var _ArtistTag = __webpack_require__(34);

var _ArtistTag2 = _interopRequireDefault(_ArtistTag);
...
_reactDom2.default.render(_react2.default.createElement(
    ...
    _react2.default.createElement(_ArtistTag2.default, null)
...
var ArtistTag = function (_Component) {
    _inherits(ArtistTag, _Component);

    function ArtistTag() {
        _classCallCheck(this, ArtistTag);

        return _possibleConstructorReturn(this, (ArtistTag.__proto__ || Object.getPrototypeOf(ArtistTag)).apply(this, arguments));
    }

    _createClass(ArtistTag, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                { style: { position: 'absolute', bottom: '0px', right: '0px', left: '0px', textAlign: 'center', padding: '10px', color: 'white', fontColor: '#fff', fontSize: '8pt' } },
                'Logan Griswold (grissly-man)'
            );
        }
    }]);
